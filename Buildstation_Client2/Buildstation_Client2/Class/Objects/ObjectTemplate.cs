...
namespace Buildstation_Client2.Class.Objects
{
    class ObjectTemplate : PhysicalObject
    {
        ...
        public void Initalise()
        {
            ...
            SpriteState = "Wall"; // Sets the sprite to the content of the wall texture2d. You'd need to add that in the main game class somewhere under the LoadContent method. An example of what I added is below.
